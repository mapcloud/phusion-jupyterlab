...
# R-Kernel requirements
RUN apt-get install -yq libcurl4-gnutls-dev libxml2-dev libssl-dev
...
#RUN conda env create -f --file /tmp/environment.yml
...
# enabling jupyter extensions (only if pip was used to install )
